...
function isAction(object) {
  return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.isPlainObject)(object) && (0,lodash__WEBPACK_IMPORTED_MODULE_0__.isString)(object.type);
}
/**
...
function createRuntime() {
  ...
  const rungenControls = (0,lodash__WEBPACK_IMPORTED_MODULE_1__.map)(controls, (control, actionType) => (value, next, iterate, yieldNext, yieldError) => {
    if (!(0,_is_action__WEBPACK_IMPORTED_MODULE_3__.isActionOfType)(value, actionType)) {
      return false;
    }

    const routine = control(value);

    if ((0,is_promise__WEBPACK_IMPORTED_MODULE_2__["default"])(routine)) {
  ...
  const unhandledActionControl = (value, next) => {
    if (!(0,_is_action__WEBPACK_IMPORTED_MODULE_3__.isAction)(value)) {
      return false;
    }
  ...
  return action => new Promise((resolve, reject) => rungenRuntime(action, result => {
    if ((0,_is_action__WEBPACK_IMPORTED_MODULE_3__.isAction)(result)) {
      dispatch(result);
    }
