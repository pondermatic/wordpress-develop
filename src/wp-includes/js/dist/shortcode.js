...
/* harmony export */   "attrs": function() { return /* binding */ attrs; },
/* harmony export */   "fromMatch": function() { return /* binding */ fromMatch; },
...
const shortcode = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.extend)(function (options) {
  (0,lodash__WEBPACK_IMPORTED_MODULE_0__.extend)(this, (0,lodash__WEBPACK_IMPORTED_MODULE_0__.pick)(options || {}, 'tag', 'attrs', 'type', 'content'));
  ...
  if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isString)(attributes)) {
    this.attrs = attrs(attributes); // Identify a correctly formatted `attrs` object.
  } else if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isEqual)(Object.keys(attributes), ['named', 'numeric'])) {
    this.attrs = attributes; // Handle a flat object of attributes.
  } else {
    (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)(attributes, (value, key) => {
      this.set(key, value);
    });
  }
}, {
...
(0,lodash__WEBPACK_IMPORTED_MODULE_0__.extend)(shortcode.prototype, {
  /**
   ...
   */
  get(attr) {
    return this.attrs[(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isNumber)(attr) ? 'numeric' : 'named'][attr];
  },
   ...
   */
  set(attr, value) {
    this.attrs[(0,lodash__WEBPACK_IMPORTED_MODULE_0__.isNumber)(attr) ? 'numeric' : 'named'][attr] = value;
    return this;
  },
  ...
  string() {
    let text = '[' + this.tag;
    (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)(this.attrs.numeric, value => {
      if (/\s/.test(value)) {
        text += ' "' + value + '"';
      } else {
        text += ' ' + value;
    ...
    (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)(this.attrs.named, (value, name) => {
      text += ' ' + name + '="' + value + '"';
