...
const useDispatchWithMap = (dispatchMap, deps) => {
  ...
  (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.useIsomorphicLayoutEffect)(() => {
    currentDispatchMap.current = dispatchMap;
  });
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => {
    const currentDispatchProps = currentDispatchMap.current(registry.dispatch, registry);
    return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(currentDispatchProps, (dispatcher, propName) => {
...
function useSelect(mapSelect, deps) {
  ...
  const callbackMapper = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(hasMappingFunction ? mapSelect : noop, deps);

  const _mapSelect = hasMappingFunction ? callbackMapper : null;

  const registry = (0,_registry_provider_use_registry__WEBPACK_IMPORTED_MODULE_4__["default"])();
  const isAsync = (0,_async_mode_provider_use_async_mode__WEBPACK_IMPORTED_MODULE_5__["default"])(); // React can sometimes clear the `useMemo` cache.
  // We use the cache-stable `useMemoOne` to avoid
  // losing queues.

  const queueContext = (0,use_memo_one__WEBPACK_IMPORTED_MODULE_6__.useMemoOne)(() => ({
    queue: true
  }), [registry]);
  const [, forceRender] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useReducer)(s => s + 1, 0);
  const latestMapSelect = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)();
  const latestIsAsync = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(isAsync);
  const latestMapOutput = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)();
  const latestMapOutputError = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)();
  const isMountedAndNotUnsubscribing = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)(); // Keep track of the stores being selected in the _mapSelect function,
  // and only subscribe to those stores later.

  const listeningStores = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useRef)([]);
  const wrapSelect = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useCallback)(callback => registry.__unstableMarkListeningStores(() => callback(registry.select, registry), listeningStores), [registry]); // Generate a "flag" for used in the effect dependency array.
  // It's different than just using `mapSelect` since deps could be undefined,
  // in that case, we would still want to memoize it.

  const depsChangedFlag = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.useMemo)(() => ({}), deps || []);
  let mapOutput;
  ...
  (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_3__.useIsomorphicLayoutEffect)(() => {
    if (!hasMappingFunction) {
      return;
    }
    ...
    const onStoreChange = () => {
      if (isMountedAndNotUnsubscribing.current) {
        try {
          ...
          if (_wordpress_is_shallow_equal__WEBPACK_IMPORTED_MODULE_2___default()(latestMapOutput.current, newMapOutput)) {
            return;
          }
...
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/compose */ "@wordpress/compose");
/* harmony import */ var _wordpress_compose__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _use_dispatch__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../use-dispatch */ "./node_modules/@wordpress/data/build-module/components/use-dispatch/use-dispatch-with-map.js");
...
const withDispatch = mapDispatchToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(WrappedComponent => ownProps => {
  const mapDispatch = (dispatch, registry) => mapDispatchToProps(dispatch, ownProps, registry);

  const dispatchProps = (0,_use_dispatch__WEBPACK_IMPORTED_MODULE_3__["default"])(mapDispatch, []);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(WrappedComponent, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, ownProps, dispatchProps));
}, 'withDispatch');
...
const withRegistry = (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(OriginalComponent => props => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(_registry_provider__WEBPACK_IMPORTED_MODULE_3__.RegistryConsumer, null, registry => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(OriginalComponent, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, {
  registry: registry
}))), 'withRegistry');
...
const withSelect = mapSelectToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(WrappedComponent => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.pure)(ownProps => {
  const mapSelect = (select, registry) => mapSelectToProps(select, ownProps, registry);

  const mergeProps = (0,_use_select__WEBPACK_IMPORTED_MODULE_3__["default"])(mapSelect);
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(WrappedComponent, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, ownProps, mergeProps));
}), 'withSelect');
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _factory__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./factory */ "./node_modules/@wordpress/data/build-module/factory.js");
/**
 * External dependencies
 */
...
const builtinControls = {
  [SELECT]: (0,_factory__WEBPACK_IMPORTED_MODULE_1__.createRegistryControl)(registry => _ref => {
    let {
      storeKey,
      selectorName,
      args
  ...
  [RESOLVE_SELECT]: (0,_factory__WEBPACK_IMPORTED_MODULE_1__.createRegistryControl)(registry => _ref2 => {
    let {
      storeKey,
      selectorName,
      args
  ...
  [DISPATCH]: (0,_factory__WEBPACK_IMPORTED_MODULE_1__.createRegistryControl)(registry => _ref3 => {
    let {
      storeKey,
      actionName,
      args
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "convertEditPostPanels": function() { return /* binding */ convertEditPostPanels; },
/* harmony export */   "createPersistenceInterface": function() { return /* binding */ createPersistenceInterface; },
/* harmony export */   "migrateFeaturePreferencesToPreferencesStore": function() { return /* binding */ migrateFeaturePreferencesToPreferencesStore; },
/* harmony export */   "migrateIndividualPreferenceToPreferencesStore": function() { return /* binding */ migrateIndividualPreferenceToPreferencesStore; },
/* harmony export */   "migrateInterfaceEnableItemsToPreferencesStore": function() { return /* binding */ migrateInterfaceEnableItemsToPreferencesStore; },
/* harmony export */   "migrateThirdPartyFeaturePreferencesToPreferencesStore": function() { return /* binding */ migrateThirdPartyFeaturePreferencesToPreferencesStore; },
/* harmony export */   "withLazySameState": function() { return /* binding */ withLazySameState; }
/* harmony export */ });
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _storage_default__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./storage/default */ "./node_modules/@wordpress/data/build-module/plugins/persistence/storage/default.js");
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../ */ "./node_modules/turbo-combine-reducers/index.js");
...
function persistencePlugin(registry, pluginOptions) {
  ...
  function createPersistOnChange(getState, storeName, keys) {
    ...
    if (Array.isArray(keys)) {
      ...
      getPersistedState = withLazySameState(___WEBPACK_IMPORTED_MODULE_2___default()(reducers));
    } else {
  ...
  return {
    registerStore(storeName, options) {
      ...
      if (persistedState !== undefined) {
        ...
        if ((0,lodash__WEBPACK_IMPORTED_MODULE_0__.isPlainObject)(initialState) && (0,lodash__WEBPACK_IMPORTED_MODULE_0__.isPlainObject)(persistedState)) {
          // If state is an object, ensure that:
          // - Other keys are left intact when persisting only a
          //   subset of keys.
          // - New keys in what would otherwise be used as initial
          //   state are deeply merged as base for persisted value.
          initialState = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.merge)({}, initialState, persistedState);
        } else {
...
function migrateIndividualPreferenceToPreferencesStore(persistence, _ref, key) {
  ...
  let convert = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : lodash__WEBPACK_IMPORTED_MODULE_0__.identity;
  const preferencesStoreName = 'core/preferences';
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! turbo-combine-reducers */ "./node_modules/turbo-combine-reducers/index.js");
/* harmony import */ var turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var equivalent_key_map__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! equivalent-key-map */ "./node_modules/equivalent-key-map/equivalent-key-map.js");
/* harmony import */ var equivalent_key_map__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(equivalent_key_map__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony import */ var _controls__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../controls */ "./node_modules/@wordpress/data/build-module/controls.js");
/* harmony import */ var _promise_middleware__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../promise-middleware */ "./node_modules/@wordpress/data/build-module/promise-middleware.js");
...
/* harmony import */ var _metadata_selectors__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./metadata/selectors */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/selectors.js");
/* harmony import */ var _metadata_actions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./metadata/actions */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/actions.js");
/**
 * External dependencies
 */
...
function createResolversCache() {
  ...
  return {
    ...
    markAsRunning(selectorName, args) {
      if (!cache[selectorName]) {
        cache[selectorName] = new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_2___default())();
      }
...
function createReduxStore(key, options) {
  return {
    ...
    instantiate: registry => {
      ...
      let resolvers;
      const actions = mapActions({ ..._metadata_actions__WEBPACK_IMPORTED_MODULE_4__,
        ...options.actions
      }, store);
      let selectors = mapSelectors({ ...(0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(_metadata_selectors__WEBPACK_IMPORTED_MODULE_5__, selector => function (state) {
        ...
        ...(0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(options.selectors, selector => {
...
function instantiateReduxStore(key, options, registry, thunkArgs) {
  const controls = { ...options.controls,
    ..._controls__WEBPACK_IMPORTED_MODULE_6__.builtinControls
  };
  const normalizedControls = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(controls, control => control.isRegistryControl ? control(registry) : control);
  const middlewares = [(0,_resolvers_cache_middleware__WEBPACK_IMPORTED_MODULE_7__["default"])(registry, key), _promise_middleware__WEBPACK_IMPORTED_MODULE_8__["default"], _wordpress_redux_routine__WEBPACK_IMPORTED_MODULE_3___default()(normalizedControls), (0,_thunk_middleware__WEBPACK_IMPORTED_MODULE_9__["default"])(thunkArgs)];
  ...
  const enhancedReducer = turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_1___default()({
  ...
  return (0,redux__WEBPACK_IMPORTED_MODULE_10__.createStore)(enhancedReducer, {
    root: initialState
  }, (0,lodash__WEBPACK_IMPORTED_MODULE_0__.flowRight)(enhancers));
}
/**
...
function mapSelectors(selectors, store) {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(selectors, createStateSelector);
}
/**
...
function mapActions(actions, store) {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(actions, createBoundAction);
}
/**
...
function mapResolveSelectors(selectors, store) {
  const storeSelectors = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.omit)(selectors, ['getIsResolving', 'hasStartedResolution', 'hasFinishedResolution', 'hasResolutionFailed', 'isResolving', 'getCachedResolvers', 'getResolutionState', 'getResolutionError']);
  return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(storeSelectors, (selector, selectorName) => {
...
function mapResolvers(resolvers, selectors, store, resolversCache) {
  ...
  const mappedResolvers = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(resolvers, resolver => {
    if (resolver.fulfill) {
      return resolver;
    }
  ...
  const mapSelector = (selector, selectorName) => {
    ...
    const selectorResolver = function () {
      ...
      async function fulfillSelector() {
        ...
        if (_metadata_selectors__WEBPACK_IMPORTED_MODULE_5__.hasStartedResolution(metadata, selectorName, args)) {
          return;
        }
        ...
        setTimeout(async () => {
          ...
          store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_4__.startResolution(selectorName, args));

          try {
            await fulfillResolver(store, mappedResolvers, selectorName, ...args);
            store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_4__.finishResolution(selectorName, args));
          } catch (error) {
            store.dispatch(_metadata_actions__WEBPACK_IMPORTED_MODULE_4__.failResolution(selectorName, args, error));
          }
        });
      }
  ...
  return {
    ...
    selectors: (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(selectors, mapSelector)
  };
}
/**
...
async function fulfillResolver(store, resolvers, selectorName) {
  const resolver = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(resolvers, [selectorName]);
...
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils */ "./node_modules/@wordpress/data/build-module/redux-store/metadata/utils.js");
/**
 * External dependencies
 */
 ...
 */
const subKeysIsResolved = (0,_utils__WEBPACK_IMPORTED_MODULE_2__.onSubKey)('selectorName')(function () {
  let state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_1___default())();
  let action = arguments.length > 1 ? arguments[1] : undefined;

  switch (action.type) {
    case 'START_RESOLUTION':
      {
        const nextState = new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_1___default())(state);
        nextState.set((0,_utils__WEBPACK_IMPORTED_MODULE_2__.selectorArgsToStateKey)(action.args), {
          status: 'resolving'
        });
        return nextState;
      }
    ...
    case 'START_RESOLUTIONS':
      {
        ...
        for (const resolutionArgs of action.args) {
          nextState.set((0,_utils__WEBPACK_IMPORTED_MODULE_2__.selectorArgsToStateKey)(resolutionArgs), {
            status: 'resolving'
          });
        }
    ...
    case 'FAIL_RESOLUTIONS':
      {
        ...
        action.args.forEach((resolutionArgs, idx) => {
          ...
          nextState.set((0,_utils__WEBPACK_IMPORTED_MODULE_2__.selectorArgsToStateKey)(resolutionArgs), resolutionState);
        });
        return nextState;
      }
    ...
    case 'INVALIDATE_RESOLUTION':
      {
        const nextState = new (equivalent_key_map__WEBPACK_IMPORTED_MODULE_1___default())(state);
        nextState.delete((0,_utils__WEBPACK_IMPORTED_MODULE_2__.selectorArgsToStateKey)(action.args));
        return nextState;
      }
  }
...
const isResolved = function () {
  ...
  switch (action.type) {
    ...
    case 'INVALIDATE_RESOLUTION_FOR_STORE_SELECTOR':
      return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.has)(state, [action.selectorName]) ? (0,lodash__WEBPACK_IMPORTED_MODULE_0__.omit)(state, [action.selectorName]) : state;
...
function getResolutionState(state, selectorName, args) {
  const map = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(state, [selectorName]);
...
/* harmony import */ var _utils_emitter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./utils/emitter */ "./node_modules/@wordpress/data/build-module/utils/emitter.js");
/**
 * External dependencies
 */
...
function createRegistry() {
  ...
  const stores = {};
  const emitter = (0,_utils_emitter__WEBPACK_IMPORTED_MODULE_2__.createEmitter)();
  ...
  function select(storeNameOrDescriptor) {
    const storeName = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.isObject)(storeNameOrDescriptor) ? storeNameOrDescriptor.name : storeNameOrDescriptor;
  ...
  function withPlugins(attributes) {
    return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.mapValues)(attributes, (attribute, key) => {
  ...
  function registerStoreInstance(name, store) {
    ...
    store.emitter = (0,_utils_emitter__WEBPACK_IMPORTED_MODULE_2__.createEmitter)();
  ...
  function registerGenericStore(name, store) {
    _wordpress_deprecated__WEBPACK_IMPORTED_MODULE_1___default()('wp.data.registerGenericStore', {
      since: '5.9',
  ...
  function batch(callback) {
    emitter.pause();
    (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)(stores, store => store.emitter.pause());
    callback();
    emitter.resume();
    (0,lodash__WEBPACK_IMPORTED_MODULE_0__.forEach)(stores, store => store.emitter.resume());
  }
...
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash */ "lodash");
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store */ "./node_modules/@wordpress/data/build-module/store/index.js");
/**
 * External dependencies
 */
...
const createResolversCacheMiddleware = (registry, reducerKey) => () => next => action => {
  const resolvers = registry.select(_store__WEBPACK_IMPORTED_MODULE_1__["default"]).getCachedResolvers(reducerKey);
  Object.entries(resolvers).forEach(_ref => {
    let [selectorName, resolversByArgs] = _ref;
    const resolver = (0,lodash__WEBPACK_IMPORTED_MODULE_0__.get)(registry.stores, [reducerKey, 'resolvers', selectorName]);
    ...
    resolversByArgs.forEach((value, args) => {
      ...
      registry.dispatch(_store__WEBPACK_IMPORTED_MODULE_1__["default"]).invalidateResolution(reducerKey, selectorName, args);
    });
  });
  return next(action);
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "AsyncModeProvider": function() { return /* reexport safe */ _components_async_mode_provider__WEBPACK_IMPORTED_MODULE_8__["default"]; },
/* harmony export */   "RegistryConsumer": function() { return /* reexport safe */ _components_registry_provider__WEBPACK_IMPORTED_MODULE_4__.RegistryConsumer; },
/* harmony export */   "RegistryProvider": function() { return /* reexport safe */ _components_registry_provider__WEBPACK_IMPORTED_MODULE_4__["default"]; },
/* harmony export */   "combineReducers": function() { return /* reexport default from dynamic */ turbo_combine_reducers__WEBPACK_IMPORTED_MODULE_0___default.a; },
/* harmony export */   "controls": function() { return /* reexport safe */ _controls__WEBPACK_IMPORTED_MODULE_11__.controls; },
/* harmony export */   "createReduxStore": function() { return /* reexport safe */ _redux_store__WEBPACK_IMPORTED_MODULE_12__["default"]; },
/* harmony export */   "createRegistry": function() { return /* reexport safe */ _registry__WEBPACK_IMPORTED_MODULE_9__.createRegistry; },
/* harmony export */   "createRegistryControl": function() { return /* reexport safe */ _factory__WEBPACK_IMPORTED_MODULE_10__.createRegistryControl; },
/* harmony export */   "createRegistrySelector": function() { return /* reexport safe */ _factory__WEBPACK_IMPORTED_MODULE_10__.createRegistrySelector; },
/* harmony export */   "dispatch": function() { return /* binding */ dispatch; },
/* harmony export */   "plugins": function() { return /* reexport module object */ _plugins__WEBPACK_IMPORTED_MODULE_13__; },
...
/* harmony export */   "useDispatch": function() { return /* reexport safe */ _components_use_dispatch__WEBPACK_IMPORTED_MODULE_7__["default"]; },
/* harmony export */   "useRegistry": function() { return /* reexport safe */ _components_registry_provider__WEBPACK_IMPORTED_MODULE_5__["default"]; },
/* harmony export */   "useSelect": function() { return /* reexport safe */ _components_use_select__WEBPACK_IMPORTED_MODULE_6__["default"]; },
/* harmony export */   "withDispatch": function() { return /* reexport safe */ _components_with_dispatch__WEBPACK_IMPORTED_MODULE_2__["default"]; },
/* harmony export */   "withRegistry": function() { return /* reexport safe */ _components_with_registry__WEBPACK_IMPORTED_MODULE_3__["default"]; },
/* harmony export */   "withSelect": function() { return /* reexport safe */ _components_with_select__WEBPACK_IMPORTED_MODULE_1__["default"]; }
/* harmony export */ });
...
const select = _default_registry__WEBPACK_IMPORTED_MODULE_14__["default"].select;
/**
 * Given the name of a registered store, returns an object containing the store's
 * selectors pre-bound to state so that you only need to supply additional arguments,
 * and modified so that they return promises that resolve to their eventual values,
...
const dispatch = _default_registry__WEBPACK_IMPORTED_MODULE_14__["default"].dispatch;
/**
