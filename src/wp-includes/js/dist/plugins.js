...
/* harmony import */ var _wordpress_icons__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @wordpress/icons */ "./node_modules/@wordpress/icons/build-module/library/plugins.js");
...
function registerPlugin(name, settings) {
  ...
  if (!(0,lodash__WEBPACK_IMPORTED_MODULE_1__.isFunction)(render)) {
...
class PluginArea extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  constructor() {
    super(...arguments);
  ...
  getCurrentPluginsState() {
    return {
      plugins: (0,lodash__WEBPACK_IMPORTED_MODULE_1__.map)((0,_api__WEBPACK_IMPORTED_MODULE_6__.getPlugins)(this.props.scope), _ref => {
        let {
          icon,
          name,
          render
  ...
  componentDidMount() {
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addAction)('plugins.pluginRegistered', 'core/plugins/plugin-area/plugins-registered', this.setPlugins);
    (0,_wordpress_hooks__WEBPACK_IMPORTED_MODULE_3__.addAction)('plugins.pluginUnregistered', 'core/plugins/plugin-area/plugins-unregistered', this.setPlugins);
  }
  ...
  render() {
    ...
    }, (0,lodash__WEBPACK_IMPORTED_MODULE_1__.map)(this.state.plugins, _ref2 => {
      let {
        context,
        Plugin
      } = _ref2;
      return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_plugin_context__WEBPACK_IMPORTED_MODULE_4__.PluginContextProvider, {
        key: context.name,
        value: context
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_plugin_error_boundary__WEBPACK_IMPORTED_MODULE_5__.PluginErrorBoundary, {
        name: context.name,
        onError: this.props.onError
      }, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(Plugin, null)));
    }));
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PluginContextProvider": function() { return /* binding */ Provider; },
...
const withPluginContext = mapContextToProps => (0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_2__.createHigherOrderComponent)(OriginalComponent => {
  return props => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(Consumer, null, context => (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_1__.createElement)(OriginalComponent, (0,_babel_runtime_helpers_esm_extends__WEBPACK_IMPORTED_MODULE_0__["default"])({}, props, mapContextToProps(context, props))));
}, 'withPluginContext');
