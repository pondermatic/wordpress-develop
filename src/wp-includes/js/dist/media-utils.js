  ...
  return wp.media.view.MediaFrame.Post.extend({
    ...
    createStates: function createStates() {
      ...
      this.states.add([new wp.media.controller.Library({
        ...
        multiple: 'add',
        editable: false,
        library: wp.media.query((0,lodash__WEBPACK_IMPORTED_MODULE_0__.defaults)({
          type: 'image'
...
const slimImageObject = img => {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_0__.pick)(img, attrSet);
};
...
class MediaUpload extends _wordpress_element__WEBPACK_IMPORTED_MODULE_1__.Component {
  constructor(_ref) {
    let {
      allowedTypes,
      gallery = false,
      ...
      modalClass,
      multiple = false,
      title = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Select or Upload Media')
    } = _ref;
    super(...arguments);
  ...
  onOpen() {
    ...
    const attachments = getAttachmentsCollection((0,lodash__WEBPACK_IMPORTED_MODULE_0__.castArray)(this.props.value)); // Once attachments are loaded, set the current selection.
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "uploadMedia": function() { return /* reexport safe */ _upload_media__WEBPACK_IMPORTED_MODULE_0__.uploadMedia; }
/* harmony export */ });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "getMimeTypesArray": function() { return /* binding */ getMimeTypesArray; },
/* harmony export */   "uploadMedia": function() { return /* binding */ uploadMedia; }
/* harmony export */ });
...
function getMimeTypesArray(wpMimeTypesObject) {
  ...
  return (0,lodash__WEBPACK_IMPORTED_MODULE_1__.flatMap)(wpMimeTypesObject, (mime, extensionsString) => {
    const [type] = mime.split('/');
    const extensions = extensionsString.split('|');
    return [mime, ...(0,lodash__WEBPACK_IMPORTED_MODULE_1__.map)(extensions, extension => `${type}/${extension}`)];
  });
}
/**
...
async function uploadMedia(_ref) {
  ...
  const setAndUpdateFiles = (idx, value) => {
    (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_3__.revokeBlobURL)((0,lodash__WEBPACK_IMPORTED_MODULE_1__.get)(filesSet, [idx, 'url']));
    filesSet[idx] = value;
    onFileChange((0,lodash__WEBPACK_IMPORTED_MODULE_1__.compact)(filesSet));
  ...
  const isAllowedType = fileType => {
    ...
    return (0,lodash__WEBPACK_IMPORTED_MODULE_1__.some)(allowedTypes, allowedType => {
      // If a complete mimetype is specified verify if it matches exactly the mime type of the file.
      if ((0,lodash__WEBPACK_IMPORTED_MODULE_1__.includes)(allowedType, '/')) {
        return allowedType === fileType;
      } // Otherwise a general mime type is used and we should verify if the file mimetype starts with it.


      return (0,lodash__WEBPACK_IMPORTED_MODULE_1__.startsWith)(fileType, `${allowedType}/`);
    });
  ...
  const isAllowedMimeTypeForUser = fileType => {
    return (0,lodash__WEBPACK_IMPORTED_MODULE_1__.includes)(allowedMimeTypesForUser, fileType);
  }; // Build the error message including the filename.


  const triggerError = error => {
    error.message = [(0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("strong", {
      key: "filename"
  ...
  for (const mediaFile of files) {
    ...
    if (allowedMimeTypesForUser && mediaFile.type && !isAllowedMimeTypeForUser(mediaFile.type)) {
      triggerError({
        ...
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Sorry, you are not allowed to upload this file type.'),
        file: mediaFile
      });
      continue;
    ...
    if (mediaFile.type && !isAllowedType(mediaFile.type)) {
      triggerError({
        ...
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Sorry, this file type is not supported here.'),
        file: mediaFile
      });
      continue;
    ...
    if (maxUploadFileSize && mediaFile.size > maxUploadFileSize) {
      triggerError({
        ...
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('This file exceeds the maximum upload size for this site.'),
        file: mediaFile
      });
      continue;
    ...
    if (mediaFile.size <= 0) {
      triggerError({
        code: 'EMPTY_FILE',
        message: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('This file is empty.'),
        file: mediaFile
      });
      continue;
    }
    ...
    filesSet.push({
      url: (0,_wordpress_blob__WEBPACK_IMPORTED_MODULE_3__.createBlobURL)(mediaFile)
    });
  ...
  for (let idx = 0; idx < validFiles.length; ++idx) {
    ...
    try {
      ...
      const mediaObject = { ...(0,lodash__WEBPACK_IMPORTED_MODULE_1__.omit)(savedMedia, ['alt_text', 'source_url']),
        alt: savedMedia.alt_text,
        caption: (0,lodash__WEBPACK_IMPORTED_MODULE_1__.get)(savedMedia, ['caption', 'raw'], ''),
      ...
      if ((0,lodash__WEBPACK_IMPORTED_MODULE_1__.has)(error, ['message'])) {
        message = (0,lodash__WEBPACK_IMPORTED_MODULE_1__.get)(error, ['message']);
      } else {
        message = (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.sprintf)( // translators: %s: file name
        (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_4__.__)('Error while uploading file %s to the media library.'), mediaFile.name);
      }
...
function createMediaFromFile(file, additionalData) {
  ...
  (0,lodash__WEBPACK_IMPORTED_MODULE_1__.forEach)(additionalData, (value, key) => data.append(key, value));
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "MediaUpload": function() { return /* reexport safe */ _components__WEBPACK_IMPORTED_MODULE_0__.MediaUpload; },
/* harmony export */   "uploadMedia": function() { return /* reexport safe */ _utils__WEBPACK_IMPORTED_MODULE_1__.uploadMedia; }
/* harmony export */ });
